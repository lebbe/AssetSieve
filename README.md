...
It includes specialized parsers for complex content formats like FlippingBook and IIIF, alongside a full-featured network inspector, making it an indispensable tool for developers, archivists, and security researchers.
...
5.  Use the different tabs (`Images`, `FlippingBook`, `IIIF`) to manage captured assets or the `Traffic` tab to analyze all network requests.
...
### 4. Traffic Tab (Network Analysis)
